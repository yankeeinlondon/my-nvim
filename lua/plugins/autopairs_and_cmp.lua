...
return {
  -- core cmp (NO cmp_* sources in dependencies)
  {
    ...
    config = function()
      ...
      if has_ap and cmp_autopairs and type(cmp.event) == "table"
          and type(cmp.event.on) == "function"
          and type(cmp_autopairs.on_confirm_done) == "function" then
      ...
      if type(cmp.config) == "table"
          and type(cmp.config.window) == "table"
          and type(cmp.config.window.bordered) == "function" then
      ...
      cmp.setup({
        ...
        mapping = cmp.mapping.preset.insert({
          ...
          ["<Tab>"]     = cmp.mapping(function(fallback)
            ...
            elseif has_luasnip and luasnip and luasnip.expand_or_jumpable and luasnip:expand_or_jumpable() then
